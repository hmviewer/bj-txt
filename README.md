...
- `release/타임라인-정리기-1.0.4-x64.exe`
...
- `release/타임라인-정리기-1.0.4-mac-arm64.dmg`
- `release/타임라인-정리기-1.0.4-mac-arm64.zip`
...
```bash
xattr -cr "/Applications/타임라인 정리기.app"
```
...
```text
https://github.com/hmviewer/bj-txt/releases/tag/v1.0.4
```
