...
- `release/타임라인-정리기-1.0.3-x64.exe`
...
- `release/타임라인-정리기-1.0.3-mac-arm64.dmg`
- `release/타임라인-정리기-1.0.3-mac-arm64.zip`

현재 macOS 빌드는 Apple Silicon용이며, Apple Developer 인증서 서명/공증 전 배포본입니다. 정식 외부 배포 시에는 Apple Developer ID로 서명하고 notarization을 추가하는 것을 권장합니다.
...
```text
https://github.com/hmviewer/bj-txt/releases/tag/v1.0.3
```
