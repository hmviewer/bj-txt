...
- `release/타임라인-정리기-1.0.2-x64.exe`
...
- `release/타임라인-정리기-1.0.2-mac-arm64.dmg`
- `release/타임라인-정리기-1.0.2-mac-arm64.zip`
...
```text
https://github.com/hmviewer/bj-txt/releases/tag/v1.0.2
```
